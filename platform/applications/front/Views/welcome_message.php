...
<head>
    ...
    <link href="<?php echo esc(base_url('build/app.css'), 'attr'); ?>" type="text/css" rel="stylesheet" />
    <script type="text/javascript" src="<?php echo esc(base_url('build/runtime.js'), 'attr'); ?>"></script>
    <script type="text/javascript" src="<?php echo esc(base_url('build/0.js'), 'attr'); ?>"></script>
    <script type="text/javascript" src="<?php echo esc(base_url('build/app.js'), 'attr'); ?>"></script>
</head>
<body>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-toggle">
                <button onclick="toggleMenu(); return false;">&#9776;</button>
            </li>
            <li class="menu-item hidden"><a href="<?php echo esc(site_url(), 'attr'); ?>">Home</a></li>
